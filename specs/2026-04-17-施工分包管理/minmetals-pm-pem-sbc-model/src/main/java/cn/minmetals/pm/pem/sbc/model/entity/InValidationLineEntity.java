...
@TableName("pm_sbc_in_validation_line")
public class InValidationLineEntity extends ArchivableAndTenantableAndVersionableEntity {
     ...
     * 队伍名称
     */
    @TableField(value = "subcontractor_scn_name", keepGlobalFormat = true)
    private String subcontractorScnName;

    /**
     * 进场验证模板编码
     */
    @TableField(value = "sub_in_validation_temp_code", keepGlobalFormat = true)
    private String subInValidationTempCode;

    /**
     * 进场验证模板名称
     */
    @TableField(value = "sub_in_validation_temp_name", keepGlobalFormat = true)
    private String subInValidationTempName;

    /**
     * 备注
     */
    @TableField(value = "rmks", keepGlobalFormat = true)
    private String rmks;

    /**
     * 进场时间
     */
    @TableField(value = "entry_time", keepGlobalFormat = true)
